...
describe("replay repositories", () => {
  test("stores replay runs, judgments, and human reviews", async () => {
    ...
    try {
      ...
      expect(listJudgmentsForTask(dbPath, "0197d239-7c00-7000-8000-000000000101")).toHaveLength(1);
  ...
  test("ignores duplicate replay runs and judgments", async () => {
    const dir = await mkdtemp(join(tmpdir(), "model-routing-replay-"));
    const dbPath = join(dir, "model-routing.db");
    ...
    try {
      ...
      insertReplayRun(dbPath, baseline);
      insertReplayRun(dbPath, { ...baseline, id: "0197d239-7c00-7000-8000-000000000202" });

      const judgment = {
        id: "0197d239-7c00-7000-8000-000000000301",
        evalTaskId: "0197d239-7c00-7000-8000-000000000101",
        candidateRunId: "0197d239-7c00-7000-8000-000000000201",
        baselineRunId: "0197d239-7c00-7000-8000-000000000201",
        position: "candidate_first",
        promptVersion: "pairwise-v1",
        createdAt: 5,
      ...
      insertJudgment(dbPath, judgment);
      insertJudgment(dbPath, { ...judgment, id: "0197d239-7c00-7000-8000-000000000302" });

      expect(listReplayRunsForTask(dbPath, "0197d239-7c00-7000-8000-000000000101")).toHaveLength(1);
      expect(listJudgmentsForTask(dbPath, "0197d239-7c00-7000-8000-000000000101")).toHaveLength(1);
    } finally {
      await rm(dir, { recursive: true, force: true });
    }
